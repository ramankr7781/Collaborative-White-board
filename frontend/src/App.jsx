...
function App() {
  ...
  const handleCreateBoard = async () => {
    try {
      const res = await createBoard("My Board");
  ...
  const handleSaveBoard = async () => {
    ...
    try {
      await updateBoard(boardId, boardTitle, elements);
      await fetchBoards();
              ...
              <button
                onClick={() => {
                  openConfirm({
                    title: "Delete board?",
                    message:
                      "This board will be removed permanently. This action cannot be undone.",
                    confirmText: "Delete",
                    confirmVariant: "danger",
                    onConfirm: async () => {
                      try {
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
            ...
            <div style={{ display: "flex", gap: "8px" }}>
              ...
              <div
                ...
                onMouseEnter={() => setHoverRequests(true)}
                onMouseLeave={() => setHoverRequests(false)}
              >
                <button
                  style={{
                    padding: "4px 10px",
              ...
              <div
                style={{ position: "relative" }}
                onMouseEnter={() => setHoverMembers(true)}
                onMouseLeave={() => setHoverMembers(false)}
              >
                <button
                  style={{
                    padding: "4px 10px",
                        ...
                        >
                          ...
                          <button
                            onClick={() => {
                              openConfirm({
                                title: "Remove member?",
                                message: `Remove ${member.name} from this board? They will lose access until invited again.`,
                                confirmText: "Remove",
                                confirmVariant: "danger",
                                onConfirm: async () => {
                                  try {
        ...
        {accessDenied ? (
          ...
          >
            ...
            >
              ...
              >
                You don't have access to this board. You can request access from
                the owner.
              </p>
              <button
                onClick={async () => {
